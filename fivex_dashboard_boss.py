...
net_commission  = orders_f["commission"].sum() - returns_f["commission"].sum() - cancelled_f["commission"].sum()
net_delivery    = orders_f["delivery_costs"].sum() - returns_f["delivery_costs"].sum() - cancelled_f["delivery_costs"].sum()
net_pick_pack   = orders_f["pick_pack_costs"].sum() - returns_f["pick_pack_costs"].sum() - cancelled_f["pick_pack_costs"].sum()
net_extra       = orders_f["extra_costs"].sum() - returns_f["extra_costs"].sum() - cancelled_f["extra_costs"].sum()
net_purchase    = orders_f["purchase_costs"].sum() - returns_f["purchase_costs"].sum() - cancelled_f["purchase_costs"].sum()
